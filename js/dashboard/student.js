...
async function dashboardStudent(token) {
    const result = await fetch("https://hack3shcool.onrender.com/dashboard/student", {
        method: "GET",
        headers: {
...
document.addEventListener("click", async (e) => {
    ...
    if (e.target.classList.contains("delete")) {
        console.log(e.target.id);
        const result = await fetch(`https://hack3shcool.onrender.com/dashboard/student/cours/${e.target.id}/erase`, {
            method: "DELETE",
            headers: {
